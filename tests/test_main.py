...
class TestMainFunctions:
    ...
    @pytest.mark.parametrize("mock_data, year, expected_transactions", [
        (
            ...
            2024,
            [
                {'Date': '01 July 2024', 'Description': 'FAST PAYMENT 123456789 to JOHN DOE OTHR - Other', 'Withdrawal': -700.0, 'Deposit': 0, 'Balance': 57169.97},
                {'Date': '03 July 2024', 'Description': 'FAST PAYMENT via PayNow-Mobile to JANE SMITH OTHR - OTHR', 'Withdrawal': -22.54, 'Deposit': 0, 'Balance': 57147.43},
                {'Date': '08 July 2024', 'Description': 'FAST PAYMENT 987654321 to ALICE JOHNSON OTHR - Other', 'Withdrawal': -3000.0, 'Deposit': 0, 'Balance': 54147.43},
                {'Date': '09 July 2024', 'Description': 'BONUS INTEREST SALARY BONUS', 'Withdrawal': 0, 'Deposit': 205.47, 'Balance': 54352.9},
                {'Date': '09 July 2024', 'Description': 'BONUS INTEREST CC SPEND BONUS', 'Withdrawal': 0, 'Deposit': 49.31, 'Balance': 54402.21},
                {'Date': '09 July 2024', 'Description': 'BONUS INTEREST SAVE BONUS', 'Withdrawal': 0, 'Deposit': 123.28, 'Balance': 54525.49},
                {'Date': '09 July 2024', 'Description': 'BONUS INTEREST GROW BONUS', 'Withdrawal': 0, 'Deposit': 197.26, 'Balance': 54722.75},
                {'Date': '15 July 2024', 'Description': 'POS PURCHASE NETS STORE A STORE B MALL', 'Withdrawal': -207.4, 'Deposit': 0, 'Balance': 54515.35},
                {'Date': '18 July 2024', 'Description': 'GIRO COLL 100100123456 CR CARD RECEIVABLE', 'Withdrawal': -2155.03, 'Deposit': 0, 'Balance': 52360.32},
                {'Date': '29 July 2024', 'Description': 'GIRO - SALARY SALA Company A Pte Ltd Company A Pte Ltd', 'Withdrawal': 0, 'Deposit': 5357.0, 'Balance': 57717.32},
                {'Date': '30 July 2024', 'Description': 'FUND TRANSFER via PayNow-QR Code to BOB BROWN OTHR - OTHR', 'Withdrawal': -3.9, 'Deposit': 0, 'Balance': 57713.42},
                {'Date': '31 July 2024', 'Description': 'INTEREST CREDIT', 'Withdrawal': 0, 'Deposit': 23.54, 'Balance': 57736.96}
            ]
        ),
        (
            [
            ...
            2024,
            [
                {'Date': '19 August 2024', 'Description': 'Payments / Collections via GIRO CARD CENTRE CARDHOLDER 123456789012', 'Withdrawal': -1269.68, 'Deposit': 0, 'Balance': 25028.83},
                {'Date': '28 August 2024', 'Description': 'FAST Payment / Receipt LOAN REPAYMENT 20240828BANKSGSGBRT1234567 OTHER', 'Withdrawal': 0, 'Deposit': 1000.0, 'Balance': 26028.83},
                {'Date': '31 August 2024', 'Description': 'Interest Earned', 'Withdrawal': 0, 'Deposit': 0.89, 'Balance': 26029.72}
            ]
        )
    ])
